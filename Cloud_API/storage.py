...
class Storage():
	...
	def __init__(self):
		...
		self.gcp_project_id = 'gcp-de-exp'
		os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = 'F:/work projects/customer_segmentation/google-credentials/application_default_credentials.json'
